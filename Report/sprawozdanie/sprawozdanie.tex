...
Kolejnym ważnym spostrzeżeniem jest fakt, iż ważone słowa kluczowe możemy używać jedynie dla wektorów wyekstrahowanych cech liczbowych. Co za tym idzie, eksperymenty wykorzystujące ważone słowa kluczowe będą przeprowadzone jedynie z użyciem metryk. \newline
...
\item $Features$ zawierający podpakiety $Number$ i $Text$,
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{{Diagramy/PackageTraining.png}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{{Diagramy/PackageTesting.png}}
...
\begin{figure}[H]
	...
	\caption{Diagram UML dla podpakietu $Number$ pakietu $Features$}
\end{figure}

\subsubsection{Podpakiet Text}
Podobnie jak w przypadku popdakietu $Numbers$, klasy podpakietu $Text$ implementują jeden interfejs. \newline

Klasy podpakietu $Text$ są następujące:
\begin{itemize}[label=$\bullet$\scshape\bfseries]
\item $TextFeature$ - interfejs implementowany przez wszystkie klasy należące do tego podpakietu,
\item $FirstKeyWordInBodyTextFeature$ - klasa ekstrahująca cechę $C_{13}$.
\item $MostCommonKeyWordInBodyTextFeature$ - klasa ekstrahująca cechę $C_{14}$.
\item $LastKeyWordInBodyTextFeature$ - klasa ekstrahująca cechę $C_{15}$.\newline
\end{itemize}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Diagramy/PackageTextFeatures.png}}
	\caption{Diagram UML dla podpakietu $Text$ pakietu $Features$}
\end{figure}
...
Podpakiet $Measures$ zawiera implementacje obu miar podobieństwa tekstów omówionych we wprowadzeniu. Miary implementują interfejs $Ngram$, są bowiem one odmianami metody ngramów. \newline

Podpakiet $Measures$ zawiera następująces klasy:
\begin{itemize}[label=$\bullet$\scshape\bfseries]
\item $Ngram$ - interfejs implementowany przez obie miary,
\item $Bigram$ - klasa implementująca metodę bigramów,
...
20	&	83,38	&	91,35	\\
		\hline
	\end{tabular}
	\caption{Skuteczność klasyfikacji dla miary bigramów}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{c c c c c c} 
		...
		\hline
		\hline 
Usa		&	98,24	&	98,36	&	98,42	&	98,72	&	98,08 \\
West-Germany	&	15,62	&	9,38	&	25,00	&	8,33	&	22,92 \\
Uk		&	72,59	&	82,23	&	79,19	&	23,35	&	44,67 \\
Japan	&	33,53	&	25,75	&	38,92	&	17,96	&	32,93 \\
Canada	&	1,76	&	1,76	&	3,52	&	4,85	&	7,05 \\
France	&	16,36	&	14,55	&	30,91	&	3,64	&	16,36 \\
		\hline
	\end{tabular}
	\caption{Wartości miary recall dla klasyfikacji z wykorzystaniem wszystkich badanych metryk, kategoria "places"}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{c c c c c c} 
		...
		\hline
		\hline 
Usa	&	86,65	&	86,47	&	87,84	&	83,97	&	86,19 \\
West-germany	&	88,24	&	75,00	&	88,89	&	80,00	&	68,75 \\
Uk	&	97,28	&	94,19	&	92,31	&	65,71	&	72,13 \\
Japan	&	75,68	&	84,31	&	79,27	&	90,91	&	75,34 \\
Canada	&	8,00	&	9,09	&	18,18	&	24,44	&	36,36 \\
France	&	64,29	&	72,73	&	70,83	&	33,33	&	52,94 \\
		\hline
	\end{tabular}
	\caption{Wartości miary precision dla klasyfikacji z wykorzystaniem wszystkich badanych metryk, kategoria "places"}
\end{table}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/metryki_places_recall.png}}
	\caption{Wizualizacja danych z Tabeli 12}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/metryki_places_precision.png}}
	\caption{Wizualizacja danych z Tabeli 13}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/metryki_topics_recall.png}}
	\caption{Wizualizacja danych z Tabeli 14}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/metryki_topics_precision.png}}
	\caption{Wizualizacja danych z Tabeli 15}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/measures_places_recall.png}}
	\caption{Wizualizacja danych z Tabeli 16}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/measures_places_precision.png}}
	\caption{Wizualizacja danych z Tabeli 17}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/measures_topics_recall.png}}
	\caption{Wizualizacja danych z Tabeli 18}
\end{figure}


\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{{Wykresy/measures_topics_precision.png}}
	\caption{Wizualizacja danych z Tabeli 19}
\end{figure}
